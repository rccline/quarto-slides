...
**To summarize**: - Use the `#| fig-cap: "Your caption text"` syntax in the code chunk options to set the figure caption. - Use the `#| fig-alt: "Your alternative text"` syntax to provide alternative text for accessibility purposes. - Use the `@fig-label` syntax in your Quarto document to cross-reference the figure, replacing `label` with the actual label you assigned to the figure code chunk.
